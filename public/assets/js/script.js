...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (testimonialsSlider) {
        ...
        function getSlideStep() {
            ...
            const gap = parseFloat(window.getComputedStyle(testimonialsSlider).gap) || 0;
...
const authSwitchLinks = document.querySelectorAll('.auth-switch-link[data-switch]');
...
// ===================================
function initAuth() {
    // Only intercept legacy in-page auth tabs. Laravel auth links should navigate normally.
    const authToggleBtns = document.querySelectorAll('.auth-pill-btn[data-form], .auth-toggle-btn[data-form]');
